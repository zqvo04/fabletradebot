...
| **v3 연속 포트폴리오 (최종 채택)** | **전 게이트 통과** — 전 기간 **+38.21%/MDD −6.0%/샤프 2.16**, 홀드아웃 2026 **+29.01%** (v2 −0.8%), 민감도 8코너 +18~+60%, 비용 2배 +23.9% | [REDESIGN_V3.md](REDESIGN_V3.md) / [VALIDATION_V3.md](VALIDATION_V3.md) |
