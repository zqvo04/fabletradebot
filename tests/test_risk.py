...
def test_conf_tier_mapping():
    ...
    assert conf_tier(0.55, P) == (5.0, 0.006)
    assert conf_tier(0.95, P) == (5.0, 0.006)
    ...
    assert conf_tier(0.65, p2) == (2.0, 0.005)
    assert conf_tier(0.95, p2) == (10.0, 0.015)
